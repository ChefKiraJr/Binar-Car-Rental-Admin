      ...
      <div className="bg-white pb-8">
        <div className="">
          ...
          <div className="pt-6 pb-2">
            <p className="text-lg font-bold">Menghapus Data Mobil</p>
          </div>
          ...
          <div className="flex justify-around">
            <button
              class="bg-blue-700 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded w-[90px] "
              onClick={() => deletePost()}
            >
              Ya
            </button>
            <button
              class="bg-white hover:text-blue-500 text-blue-700 border-[1px] border-blue-700 border-solid  font-bold py-2 px-4 rounded w-[90px]"
